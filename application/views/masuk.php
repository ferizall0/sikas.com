                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
            								...
            								<td>
            									<a id="edit_data" data-toggle="modal" data-target="#edit" data-kode="<?= $row->kode; ?>" data-ket="<?= $row->keterangan; ?>" data-tgl="<?= $row->tgl; ?>" data-jml="<?= $row->jumlah; ?>" href="#" class="btn btn-info"><i class="fa fa-edit"></i>Edit</a>

            									<a onclick="return confirm('Yakin Akan Menghapus Data Ini ??')" href="<?= site_url('masuk/del/'.$row->kode); ?>" class="btn btn-danger"><i class="fa fa-trash"></i>Hapus</a>
            								</td>
                                        </tr>
                                        <?php 
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" id="modal_edit">
                                            ...
                                            <?php echo form_open('masuk/proses', '', array('kode' => $row->kode)); ?>
